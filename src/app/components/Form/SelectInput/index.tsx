...
export function SelectInput({ children, placeholder }: SelectInputProps) {
  return (
    <SelectPrimitive.Root>
      <SelectPrimitive.Trigger className="ga-2 flex h-11 w-full items-center justify-between rounded-lg border border-zinc-300 px-3 py-2 shadow-sm data-[placeholder]:text-zinc-600">
